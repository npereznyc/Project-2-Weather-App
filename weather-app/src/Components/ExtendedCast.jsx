    ...
    if(weatherData){
        ...
        <div className="ExtendedCast">
            <div className="Cast0">
                ...
                <h4>{weatherData?.daily?.sunset[0]}</h4>
            ...
            <div className="Cast1">
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[1]}°F  Low: {weatherData?.daily?.temperature_2m_min[1]}°F</h4>
                <h4>{weatherData?.daily?.sunset[1]}</h4>
            ...
            <div className="Cast2">
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[2]}°F  Low: {weatherData?.daily?.temperature_2m_min[2]}°F</h4>
                <h4>{weatherData?.daily?.sunset[2]}</h4>
            ...
            <div className="Cast3">
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[3]}°F  Low: {weatherData?.daily?.temperature_2m_min[3]}°F</h4>
                <h4>{weatherData?.daily?.sunset[3]}</h4>
            ...
            <div className="Cast4">
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[4]}°F  Low: {weatherData?.daily?.temperature_2m_min[4]}°F</h4>
                <h4>{weatherData?.daily?.sunset[4]}</h4>
            ...
            <div className="Cast5">
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[5]}°F  Low: {weatherData?.daily?.temperature_2m_min[5]}°F</h4>
                <h4>{weatherData?.daily?.sunset[5]}</h4>
            ...
            <h3>{weatherData?.daily?.time[6]}</h3>
                ...
                <h4>High: {weatherData?.daily?.temperature_2m_max[6]}°F  Low: {weatherData?.daily?.temperature_2m_min[6]}°F</h4>
                <h4>{weatherData?.daily?.sunset[6]}</h4>
                <h4>Wind {windHashmap.get(weatherData?.daily?.winddirection_10m_dominant[5])} at {weatherData?.daily?.windspeed_10m_max[5]}mph</h4>
            </div>
        </div>
  )
